...
export function ExpenseBreakdown() {
  ...
  const expenseSlices = useMemo(() => buildExpenseSlices(journalEntries), [journalEntries]);
    ...
    <section className="dashboard-panel dashboard-panel--breakdown" aria-labelledby="expense-breakdown">
      ...
      <div className="dashboard-breakdown">
        <div className="dashboard-breakdown__visual">
          <svg aria-label="Expense breakdown donut chart" className="dashboard-donut" role="img" viewBox={`0 0 ${chartSize} ${chartSize}`}>
            <circle
